...
# check-health.sh - report possible issues in a modular repository
...
check-health - report possible issues in a modular documentation repository
...
The B<check-health> utility checks the current health of a modular
documentation repository and prints a detailed report to standard output.
